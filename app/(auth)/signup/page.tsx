        ...
        <div className="w-full max-w-2xl lg:py-0 py-8">
          ...
          <div className="flex gap-4 mb-6">
            <button
              ...
              className={`flex-1 py-3 px-6 rounded-lg font-semibold transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer ${
                formData.role === "patient"
                  ? "bg-[#6685FF] text-white shadow-md"
                  : "bg-white text-black/80 border border-gray-300 hover:border-[#6685FF]/50"
              }`}
            >
              Patient
            </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border font-roboto-flex text-black transition-all duration-200 ${
                  errors.fullName ? "border-red-500" : "border-gray-300"
                } focus:outline-none focus:ring-2 focus:ring-[#6685FF] hover:border-[#6685FF]/50`}
              />
              {errors.fullName && (
                <p className="text-red-500 text-xs mt-1 font-roboto-flex animate-in fade-in slide-in-from-top duration-300">
                  {errors.fullName}
                </p>
              )}
            </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-3 px-6 rounded-lg font-semibold text-white transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 font-roboto-flex cursor-pointer"
